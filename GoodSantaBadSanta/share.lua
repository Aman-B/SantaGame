...
publicClass.onShareButtonReleased= function ( event )
    ...
    if isAvailable then
        ...
        native.showPopup( "social",
        {
            ...
            message = "I collected "..scoreToSend.." gifts in this awesome christmas game. Check it out here!",
            listener = listener,
           
            url = 
            { 
                "https://play.google.com/store/apps/details?id=com.bewtechnologies.GoodSantaBadSanta",
            }
        })
    else
        if isSimulator then
